...
func TestGenCTICFn(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			query:       "fieldType",
			value:       "value",
			expectedSQL: "LOWER(fieldType) LIKE LOWER(CONCAT('%', CAST(? AS text), '%'))",
			expectedOK:  true,
		},
	}
...
func TestGenNCTICFn(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			query:       "fieldType",
			value:       "value",
			expectedSQL: "LOWER(fieldType) NOT LIKE LOWER(CONCAT('%', CAST(? AS text), '%'))",
			expectedOK:  true,
		},
	}
...
func TestGenCTFn(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			query:       "fieldType",
			value:       "value",
			expectedSQL: "fieldType LIKE CONCAT('%', CAST(? AS text), '%')",
			expectedOK:  true,
		},
	}
...
func TestGenNCTFn(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			query:       "fieldType",
			value:       "value",
			expectedSQL: "fieldType NOT LIKE CONCAT('%', CAST(? AS text), '%')",
			expectedOK:  true,
		},
	}
